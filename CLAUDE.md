...
```bash
npm install
npm test                  # 346 unit tests via node --test
...
```bash
node --test test/*.test.js            # full suite (346 tests)
